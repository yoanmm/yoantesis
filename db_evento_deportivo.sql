...
-- ----------------------------
INSERT INTO `atleta_estado` VALUES (1, 'Permitido');
INSERT INTO `atleta_estado` VALUES (2, 'No permitido');
INSERT INTO `atleta_estado` VALUES (4, 'Lesionado');
INSERT INTO `atleta_estado` VALUES (6, 'Suspendido');
...
-- ----------------------------
INSERT INTO `atleta_tipo` VALUES (1, 'Estudiante');
INSERT INTO `atleta_tipo` VALUES (2, 'Trabajador');
...
-- Records of cancha
-- ----------------------------
INSERT INTO `cancha` VALUES (1, 'Futsal');
INSERT INTO `cancha` VALUES (10, 'Piscina');
INSERT INTO `cancha` VALUES (11, 'Tatami');
INSERT INTO `cancha` VALUES (12, 'Terreno de baseball');
INSERT INTO `cancha` VALUES (13, 'Terreno de softball');
INSERT INTO `cancha` VALUES (15, 'Basquet 1');
INSERT INTO `cancha` VALUES (16, 'Basquet 2');
INSERT INTO `cancha` VALUES (17, 'Fútbol 11');
INSERT INTO `cancha` VALUES (18, 'Voleibol');
...
CREATE TABLE `competencia`  (
  ...
  `resultado_competencia` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `compromiso_participacion`;
CREATE TABLE `compromiso_participacion`  (
  `id_compromiso` int(11) NOT NULL,
  `id_delegacion_evento` int(11) NULL DEFAULT NULL,
  `id_deporte` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id_compromiso`) USING BTREE,
  INDEX `id_delegacion_evento`(`id_delegacion_evento`) USING BTREE,
  INDEX `id_deporte`(`id_deporte`) USING BTREE,
  CONSTRAINT `compromiso_participacion_ibfk_1` FOREIGN KEY (`id_delegacion_evento`) REFERENCES `delegacion_evento` (`id_delegacion_evento`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `compromiso_participacion_ibfk_2` FOREIGN KEY (`id_deporte`) REFERENCES `deporte` (`id_deporte`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of compromiso_participacion
-- ----------------------------
...
CREATE TABLE `delegacion`  (
  ...
  `reglamento` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `delegacion_regla`  (
  ...
  `regla` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `deporte_categoria_puntuacion` VALUES (1, 'De a 5', '50,45,40,35,30,25,20,15,10,5');
INSERT INTO `deporte_categoria_puntuacion` VALUES (2, 'De a 3', '27,24,21,18,15,12,9,6,3');
INSERT INTO `deporte_categoria_puntuacion` VALUES (3, 'De a 2', '17,15,13,11,9,7,5,3,1');
INSERT INTO `deporte_categoria_puntuacion` VALUES (4, 'Alta', '25,22,19,16,13,10,7,5,3');
INSERT INTO `deporte_categoria_puntuacion` VALUES (5, 'Media', '15,13,11,9,7,5,3,2,1');
INSERT INTO `deporte_categoria_puntuacion` VALUES (6, 'Baja', '10,8,7,6,5,4,3,2,1');
...
CREATE TABLE `deporte_regla`  (
  ...
  `nombre_regla` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `campos` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `cal_campos` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `equipo_estado` VALUES (1, 'Expulsado');
INSERT INTO `equipo_estado` VALUES (2, 'Aprobado');
INSERT INTO `equipo_estado` VALUES (3, 'Pendiente a revisión');
INSERT INTO `equipo_estado` VALUES (4, 'Pendiente a sanción');
...
CREATE TABLE `evento_deportivo`  (
  ...
  `terminado` tinyint(4) NULL DEFAULT NULL,
  `resultado_edicion` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `juego`  (
  ...
  CONSTRAINT `juego_ibfk_4` FOREIGN KEY (`id_supervisor`) REFERENCES `persona_arbitro` (`id_supervisor`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `juego_delegacion`  (
  ...
  `id_delegacion` int(11) NULL DEFAULT NULL,
  `resultados` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `juego_fase` VALUES (1, 'Final', 1);
INSERT INTO `juego_fase` VALUES (2, 'Semifinales', 0);
INSERT INTO `juego_fase` VALUES (3, 'Cuartos', 0);
INSERT INTO `juego_fase` VALUES (4, 'Octavos', 0);
INSERT INTO `juego_fase` VALUES (5, 'Dieciseisavos', 0);
INSERT INTO `juego_fase` VALUES (6, 'Grupos', 0);
...
-- Records of persona
-- ----------------------------
INSERT INTO `persona` VALUES (1, 'Tony', 'Garcia', '94092899001', 'Masculino', 'Informática');
INSERT INTO `persona` VALUES (2, 'Yoan', 'Montero', '01051764509', 'Masculino', 'Informática');
INSERT INTO `persona` VALUES (3, 'Abuelo', 'Rivero', '78041380914', 'Masculino', 'Informática');
INSERT INTO `persona` VALUES (4, 'Alberto', 'Ferrer', '00120609757', 'Masculino', 'Informática');
