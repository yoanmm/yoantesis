          ...
          <ul class="navbar-nav nav-left">
            ...
            <!-- <li class="nav-item dropdown" v-for="(item,index) in menu" :key="index">
              ...
              <div class="dropdown-menu animated fadeIn" aria-labelledby="navbarDropdown">
                <router-link class="dropdown-item nav-link" v-for="(subitem,index) in item.routes" :key="'s-'+index"
                    ...
                    <ul class="scrollbar scroll_dark max-h-240">
                        ...
                        <a href="javascript:void(0)">
                          <div class="notification d-flex flex-row align-items-center">
                            <div class="notify-icon bg-img align-self-center">
                              <img class="img-fluid" src="/static/assets/img/avtar/03.jpg"
                                   alt="user3">
                            </div>
                      ...
                      <li>
                        <a href="javascript:void(0)">
                          <div class="notification d-flex flex-row align-items-center">
                            <div class="notify-icon bg-img align-self-center">
                              <img class="img-fluid" src="/static/assets/img/avtar/01.jpg"
                                   alt="user">
                            </div>
                            <div class="notify-message">
                      ...
                      <li>
                        <a href="javascript:void(0)">
                          <div class="notification d-flex flex-row align-items-center">
                            <div class="notify-icon bg-img align-self-center">
                              <img class="img-fluid" src="/static/assets/img/avtar/02.jpg"
                                   alt="user2">
                            </div>
                            <div class="notify-message">
                      ...
                      <li>
                        <a href="javascript:void(0)">
                          <div class="notification d-flex flex-row align-items-center">
                            <div class="notify-icon bg-img align-self-center">
                              <img class="img-fluid" src="/static/assets/img/avtar/04.jpg"
                                   alt="user4">
                            </div>
                            <div class="notify-message">
                      ...
                      <li>
                        <a href="javascript:void(0)">
                          <div class="notification d-flex flex-row align-items-center">
                            <div class="notify-icon bg-img align-self-center">
                              <img class="img-fluid" src="/static/assets/img/avtar/05.jpg"
                                   alt="user5">
                            </div>
                            <div class="notify-message">
                      ...
                      <li>
                        <a href="javascript:void(0)">
                          <div class="notification d-flex flex-row align-items-center">
                            <div class="notify-icon bg-img align-self-center">
                              <img class="img-fluid" src="/static/assets/img/avtar/06.jpg"
                                   alt="user6">
                            </div>
                            <div class="notify-message">
...
export default {
  ...
  methods: {
    access_menu_load() {
      if (!this.$store.site.user.roles || !this.$store.site.user.roles.some((n) => n === "ROLE_SUPER_ADMIN")) {
