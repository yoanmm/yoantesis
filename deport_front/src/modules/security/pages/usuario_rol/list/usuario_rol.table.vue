<template>
  ...
  >
   ...
   <a-menu-item key="2">
    ...
    <slot :slot="'id_user_rol'" slot-scope='record' name='id_user_rol' :record='record'/>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedUsuario_rol(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
