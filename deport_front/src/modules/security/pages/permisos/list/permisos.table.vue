<template>
  ...
  >
   ...
   <a-menu-item key="2">
    ...
    <slot :slot="'id_permiso'" slot-scope='record' name='id_permiso' :record='record'/>
    <slot :slot="'nombre_permiso'" slot-scope='record' name='nombre_permiso' :record='record'/>
    <slot :slot="'code'" slot-scope='record' name='code' :record='record'/>
    <slot :slot="'modulo'" slot-scope='record' name='modulo' :record='record'/>
    <slot :slot="'controller'" slot-scope='record' name='controller' :record='record'/>
    <slot :slot="'accion'" slot-scope='record' name='accion' :record='record'/>
    <slot :slot="'habilitado'" slot-scope='record' name='habilitado' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedPermisos(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
