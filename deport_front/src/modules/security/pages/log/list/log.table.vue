<template>
  ...
  >
    ...
    <slot :slot="'nombre_accion'" slot-scope='record' name='nombre_accion' :record='record'/>
    <slot :slot="'tabla'" slot-scope='record' name='tabla' :record='record'/>
    <slot :slot="'record'" slot-scope='record' name='record' :record='record'/>
    <slot :slot="'ip'" slot-scope='record' name='ip' :record='record'/>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedLog(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
