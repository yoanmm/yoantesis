<template>
  ...
  >
    ...
    <slot :slot="'id_rol_permiso'" slot-scope='record' name='id_rol_permiso' :record='record'/>
    <slot :slot="'id_rol'" slot-scope='record' name='id_rol' :record='record'/>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedRol_permiso(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
