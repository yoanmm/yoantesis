<template>
  ...
  >
   ...
   <a-menu-item key="2">
    ...
    <slot :slot="'estado_equipo'" slot-scope='record' name='estado_equipo' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedEquipo_estado(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
