...
export default {
  name: "compromiso_participacion_table",
  ...
  inject: {
    ...
    setSelectedCompromiso_participacion: {
      default: () => {
      }
    }
  },
  props: {
    ...
    table_name: {
      type: String,
      default: "compromiso_participacion"
    },
    url: {
      type: String,
      default: null
  ...
  methods: {
    ...
    showDeleteConfirm() {
      ...
      this.$confirm({
        ...
        async onOk() {
          try {
            const response = await mb.statics(_this.table_name).delete_by_ids(
    ...
    onEditing(model) {
      ...
      this.setSelectedCompromiso_participacion(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
