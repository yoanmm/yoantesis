<template>
  ...
  >
    ...
    <slot :slot="'nombre_categoria'" slot-scope='record' name='nombre_categoria' :record='record'/>
    <slot :slot="'puntos'" slot-scope='record' name='puntos' :record='record'/>
  </a-table>
</template>
...
export default {
  name: "deporte_categoria_puntuacion_table",
  ...
  inject: {
    ...
    setSelectedDeporte_categoria_puntuacion: {
      default: () => {
      }
    }
  },
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedDeporte_categoria_puntuacion(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
