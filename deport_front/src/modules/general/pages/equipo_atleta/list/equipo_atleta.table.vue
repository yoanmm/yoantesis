<template>
  ...
  >
   ...
   <a-menu-item key="2">
    ...
    <slot :slot="'id_equipo_atleta'" slot-scope='record' name='id_equipo_atleta' :record='record'/>
    <slot :slot="'id_equipo'" slot-scope='record' name='id_equipo' :record='record'/>
    <slot :slot="'id_atleta'" slot-scope='record' name='id_atleta' :record='record'/>
    <slot :slot="'id_estado_atleta'" slot-scope='record' name='id_estado_atleta' :record='record'/>
    <slot :slot="'capitan'" slot-scope='record' name='capitan' :record='record'/>
    <slot :slot="'subcapitan'" slot-scope='record' name='subcapitan' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedEquipo_atleta(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
