<template>
  ...
  >
    ...
    <slot :slot="'id_tipo'" slot-scope='record' name='id_tipo' :record='record'/>
    <slot :slot="'foto'" slot-scope='record' name='foto' :record='record'/>
    <slot :slot="'tamaño'" slot-scope='record' name='tamaño' :record='record'/>
    <slot :slot="'peso'" slot-scope='record' name='peso' :record='record'/>
    <slot :slot="'facultad'" slot-scope='record' name='facultad' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedPersona_atleta(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
