<template>
  <div>
    ...
    <div>
      <a-modal
        @cancel="onCloseModal"
        :title="selected_persona_atleta.get_id() ? 'Actualizar atleta' : 'Añadir atleta'"
        class="modal-form"
        width="55rem"
        ...
        async onOk() {
          try {
            const response = await mb
              .statics("Persona_atleta")
              .delete_by_ids(_this.$refs.persona_atleta_table.selectedRowKeys);
