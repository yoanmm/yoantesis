<template>
  ...
  >
    ...
    <slot :slot="'id_juego_delegacion'" slot-scope='record' name='id_juego_delegacion' :record='record'/>
    <slot :slot="'id_juego'" slot-scope='record' name='id_juego' :record='record'/>
    <slot :slot="'id_delegacion'" slot-scope='record' name='id_delegacion' :record='record'/>
    <slot :slot="'resultados'" slot-scope='record' name='resultados' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedJuego_delegacion(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
