...
import juego_delegacion_form from "../form/juego_delegacion_form";
import juego_delegacion_table from "./juego_delegacion.table";
...
export default {
  ...
  methods: {
    ...
    showDeleteConfirm() {
      if (this.$refs.juego_delegacion_table.selectedRowKeys.length === 0) {
