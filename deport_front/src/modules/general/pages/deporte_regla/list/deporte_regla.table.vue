<template>
  ...
  >
   ...
   <a-menu-item key="2">
    ...
    <slot :slot="'id_regla_deporte'" slot-scope='record' name='id_regla_deporte' :record='record'/>
    <slot :slot="'nombre_regla'" slot-scope='record' name='nombre_regla' :record='record'/>
    <slot :slot="'campos'" slot-scope='record' name='campos' :record='record'/>
    <slot :slot="'cal_campos'" slot-scope='record' name='cal_campos' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedDeporte_regla(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
