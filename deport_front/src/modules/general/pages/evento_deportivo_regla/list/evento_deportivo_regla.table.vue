<template>
  ...
  >
    ...
    <slot :slot="'regla'" slot-scope='record' name='regla' :record='record'/>
  </a-table>
</template>
...
export default {
  name: "evento_deportivo_regla_table",
  ...
  inject: {
    ...
    setSelectedEvento_deportivo_regla: {
      default: () => {
      }
    }
  },
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedEvento_deportivo_regla(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
