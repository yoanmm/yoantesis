<template>
  ...
  >
    ...
    <slot :slot="'tipo_atleta'" slot-scope='record' name='tipo_atleta' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedAtleta_tipo(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
