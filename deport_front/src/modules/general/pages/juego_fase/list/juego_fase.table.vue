<template>
  ...
  >
    ...
    <slot :slot="'nombre_fase'" slot-scope='record' name='nombre_fase' :record='record'/>
    <slot :slot="'es_final'" slot-scope='record' name='es_final' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedJuego_fase(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
