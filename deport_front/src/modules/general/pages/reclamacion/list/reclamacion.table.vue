<template>
  ...
  >
   ...
   <a-menu-item key="2">
    ...
    <slot :slot="'id_reclamacion'" slot-scope='record' name='id_reclamacion' :record='record'/>
    <slot :slot="'fecha_reclamacion'" slot-scope='record' name='fecha_reclamacion' :record='record'/>
    <slot :slot="'descripcion_reclamacion'" slot-scope='record' name='descripcion_reclamacion' :record='record'/>
    ...
    <slot :slot="'id_estado'" slot-scope='record' name='id_estado' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedReclamacion(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
