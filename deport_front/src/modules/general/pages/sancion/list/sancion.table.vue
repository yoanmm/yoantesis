<template>
  ...
  >
   ...
   <a-menu-item key="2">
    ...
    <slot :slot="'id_sancion'" slot-scope='record' name='id_sancion' :record='record'/>
    <slot :slot="'fecha_sancion'" slot-scope='record' name='fecha_sancion' :record='record'/>
    <slot :slot="'razon'" slot-scope='record' name='razon' :record='record'/>
    <slot :slot="'puntos_sancion'" slot-scope='record' name='puntos_sancion' :record='record'/>
    <slot :slot="'suspendido'" slot-scope='record' name='suspendido' :record='record'/>
    <slot :slot="'juegos_suspendidos'" slot-scope='record' name='juegos_suspendidos' :record='record'/>
    <slot :slot="'expulsado'" slot-scope='record' name='expulsado' :record='record'/>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedSancion(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
