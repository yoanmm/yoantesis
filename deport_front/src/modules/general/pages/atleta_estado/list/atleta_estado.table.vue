<template>
  ...
  >
    ...
    <slot :slot="'estado_atleta'" slot-scope='record' name='estado_atleta' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedAtleta_estado(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
