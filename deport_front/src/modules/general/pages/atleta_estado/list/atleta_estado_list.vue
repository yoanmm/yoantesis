<template>
  <div>
    <div class="row row-breadcrumb">
      <div class="col-md-6">
        <h4>Listado de Atleta_estado</h4>
      </div>
      <div class="col-md-5">
        <a-breadcrumb>
   ...
   <div>
      <a-modal
        @cancel="onCloseModal"
        :title="selected_atleta_estado.get_id()?'Actualizar atleta_estado':'Añadir atleta_estado'"
        class="modal-form"
        width="55rem"
  ...
  methods: {
    ...
    showDeleteConfirm() {
      ...
      this.$confirm({
        ...
        async onOk() {
          try {
            const response = await mb.statics('Atleta_estado').delete_by_ids(
