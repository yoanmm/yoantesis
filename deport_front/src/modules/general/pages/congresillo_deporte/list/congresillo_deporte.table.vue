<template>
  ...
  >
    ...
    <slot :slot="'fecha_congresillo'" slot-scope='record' name='fecha_congresillo' :record='record'/>
...
export default {
  name: "congresillo_deporte_table",
  ...
  inject: {
    ...
    setSelectedCongresillo_deporte: {
      default: () => {
      }
    }
  },
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedCongresillo_deporte(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
