<template>
  ...
  >
    ...
    <slot :slot="'tipo_delegacion'" slot-scope='record' name='tipo_delegacion' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedDelegacion_tipo(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
