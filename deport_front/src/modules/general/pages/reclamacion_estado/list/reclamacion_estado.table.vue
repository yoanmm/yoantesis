<template>
  ...
  >
    ...
    <slot :slot="'nombre_estado'" slot-scope='record' name='nombre_estado' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedReclamacion_estado(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
