...
export default class Juego extends BaseModel {
  ...
  id_fase
  id_cancha
  id_supervisor   // <-- añadido

  constructor(attributes = null) {
  super();
  if (attributes != null) {
    this.id_juego = attributes.id_juego || undefined;
    this.fecha_inicio = attributes.fecha_inicio
      ? moment(attributes.fecha_inicio).format('YYYY-MM-DD HH:mm:ss')
      : null;
    this.fecha_fin = attributes.fecha_fin
      ? moment(attributes.fecha_fin).format('YYYY-MM-DD HH:mm:ss')
      : null;
  ...
  set_attributes(attributes = null) {
    if (attributes != null) {
      ...
      this.fecha_inicio = moment(attributes.fecha_inicio).format('YYYY-MM-DD HH:mm:ss');
      this.fecha_fin = moment(attributes.fecha_fin).format('YYYY-MM-DD HH:mm:ss');
